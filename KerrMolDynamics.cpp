...
/*Aquí se definen las funciones necesarias para la solución de la geodésica*/
...
/*Suena raro que se llame CalculeFuerza, pero es necesario tener en cuenta que se esta utilizando 
dinámica molecular para solucionar la ecuación geodésica, así que se sigue el mismo formato de
dinámica molecular. Luego esta "Fuerza" se refiere a la contribución por parte de los símbolos
de Christoffel que aparecen en las ecuaciones geodésicas*/
...
int main(){
  ...
  double Vtheta0=0;
  double Vt0=(-gphiphi-b*gtphi)/(gphiphi*gtt-gtphi*gtphi);
  double Vphi0=(b*gtt+b*gtphi)/(gphiphi*gtt-gtphi*gtphi);
  double Vr0=0;//sqrt((-gtt*Vt0*Vt0-gphiphi*Vphi0*Vphi0-2*gtphi*Vt0*Vphi0)/grr);
